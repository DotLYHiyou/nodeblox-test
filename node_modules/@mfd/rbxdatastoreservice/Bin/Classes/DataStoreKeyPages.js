...
exports.DataStoreKeyPages = void 0;
...
const DataStoreKey_1 = require("./DataStoreKey");
 ...
 * ---
 */
class DataStoreKeyPages extends Pages_1.Pages {
    /**
     * @internal
     */
        ...
        return new Promise((resumeFunction, errorFunction) => {
            ...
            ExecutionHelper_1.ExectionHelper.ExecuteGetSorted(request)
                ...
                for (let i = 0; i < keys.length; i++) {
                    newValue.push(new DataStoreKey_1.DataStoreKey(keys[i]));
                }
...
exports.DataStoreKeyPages = DataStoreKeyPages;
