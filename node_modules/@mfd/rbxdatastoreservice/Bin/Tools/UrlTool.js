...
(0, FastLogTool_1.FASTFLAGVARIABLE)('UseSiteTests', false);
(0, FastLogTool_1.FASTFLAG)('Debug');
(0, FastLogTool_1.DYNAMIC_FASTSTRINGVARIABLE)('PreferredTestSite', 'SiteTest1');
/**
 * @internal
 */
class BaseURL {
    ...
    static GetSecureBaseURL(preferApex = false) {
        return `https://${FastLogTool_1.FFlag['Debug'] && FastLogTool_1.FFlag['UseSiteTests']
            ? exports.GlobalURLS.TestSites[(0, FastLogTool_1.DFString)('PreferredTestSite') ? (0, FastLogTool_1.DFString)('PreferredTestSite') : 'SiteTest1'][preferApex ? 'Apex' : 'BaseUrl']
    ...
    static GetBaseHost(preferApex = false) {
        return `${FastLogTool_1.FFlag['Debug'] && FastLogTool_1.FFlag['UseSiteTests']
            ? exports.GlobalURLS.TestSites[(0, FastLogTool_1.DFString)('PreferredTestSite') ? (0, FastLogTool_1.DFString)('PreferredTestSite') : 'SiteTest1'][preferApex ? 'Apex' : 'BaseUrl']
            : exports.GlobalURLS.Production[preferApex ? 'Apex' : 'BaseUrl']}`;
    }
    /**
...
class UrlHelper {
    ...
    static BuildGenericGameUrl(servicePath) {
        return BaseURL.ConstructServicePathFromSubDomain('assetgame', servicePath + '/', null, true, false);
    }
    static BuildGenericPersistenceUrl(servicePath) {
        return BaseURL.ConstructServicePathFromHost(UrlHelper.GetRobloxGamePersistenceHost(), servicePath + '/', null, true, false);
    }
    static BuildGenericPersistenceV2Url(servicePath) {
        return BaseURL.ConstructServicePathFromHost(UrlHelper.GetRobloxGamePersistenceHost(), `v2/persistence/${servicePath}`, null, true, true);
    }
    static GetCountersMultiIncrementUrl(key) {
        return BaseURL.ConstructServicePathFromSubDomain('ephemeralcounters.api', 'v1.0/MultiIncrement', {
            ApiKey: key,
        }, true, false, true);
    }
    static GetCountersUrl(key) {
        return BaseURL.ConstructServicePathFromSubDomain('ephemeralcounters.api', 'v1.1/Counters/Increment', {
            ApiKey: key,
        }, true, false, true);
    }
}
